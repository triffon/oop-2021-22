...
Car& VectorCar::operator[] (size_t i) {
    cout<<"One"<<this->capacity<<endl;
    //TBD out of range via assert
   // cout<< this->vector[0]<<endl;
    return this->vector[0];
}

const Car VectorCar::operator[] (size_t i) const {
    //TBD out of range via assert
    cout<<"Two"<<endl;
